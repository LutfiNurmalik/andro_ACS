...
import com.regulasiudara.aircargoshippingguidelines.lim_airline.Czechair;
import com.regulasiudara.aircargoshippingguidelines.lim_airline.Jetstar;
import com.regulasiudara.aircargoshippingguidelines.lim_airline.Philair;
import com.regulasiudara.aircargoshippingguidelines.lim_airline.Tnt;
import com.regulasiudara.aircargoshippingguidelines.lim_airline.Virginia;
...
public class Limitationairline extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_limitationairline);
        ...
        new Limitationairline.LoadSemua().execute();
    ...
    class LoadSemua extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Limitationairline.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(Limitationairline.this,
